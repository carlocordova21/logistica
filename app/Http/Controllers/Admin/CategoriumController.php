...
class CategoriumController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.categorium.index', compact('categoria'))
    ...
    public function create()
    {
        ...
        return view('admin.categorium.create', compact('categorium'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.categorium.show', compact('categorium'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.categorium.edit', compact('categorium'));
    }
